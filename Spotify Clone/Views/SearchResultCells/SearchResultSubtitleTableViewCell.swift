...
//  Spotify Clone
//
//  Created by Nephilim  on 11/23/22.
//
...
class SearchResultSubtitleTableViewCell: UITableViewCell {
    ...
    override func layoutSubviews() {
        ...
        subtitleLabel.frame = CGRect(x: iconImageView.right+10, y: label.bottom, width: contentView.width-iconImageView.width-20, height: labelHeight)
